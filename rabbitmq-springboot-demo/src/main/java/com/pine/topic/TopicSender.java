...
public class TopicSender {
    ...
    public void send() {
        ...
        this.rabbitTemplate.convertAndSend(RabbitmqConst.EXCHANGE_TOPIC, RabbitmqConst.RK_EMAIL, msg1);

        String msg2 = "I am user mesaages msg########";
        System.out.println("TopicSender send the 2nd : " + msg2);
        this.rabbitTemplate.convertAndSend(RabbitmqConst.EXCHANGE_TOPIC, RabbitmqConst.RK_USER, msg2);

        String msg3 = "I am error mesaages msg";
        System.out.println("TopicSender send the 3rd : " + msg3);
        this.rabbitTemplate.convertAndSend(RabbitmqConst.EXCHANGE_TOPIC, "errorkey", msg3);
    }
